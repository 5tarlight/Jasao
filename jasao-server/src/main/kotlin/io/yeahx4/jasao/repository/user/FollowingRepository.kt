...
interface FollowingRepository: JpaRepository<Following, String> {
    ...
    fun findByFollowerOrderByCreatedAtDesc(follower: Long, pageable: Pageable): List<Following>
    fun findByFollowedOrderByCreatedAtDesc(followed: Long, pageable: Pageable): List<Following>
}
